        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $more = '<div class="btn-group dropleft">
                            ...
                            <div class="dropdown-menu dropleft" x-placement="left-start" style="position:absolute; transform: translare3d(-2px, 0px, 0px); top: 0px; left: 0px; will-change: transform;">
            ...
            ->addColumn('offer_price', function ($query) {
                return currencyPosition($query->offerprice);
            })
